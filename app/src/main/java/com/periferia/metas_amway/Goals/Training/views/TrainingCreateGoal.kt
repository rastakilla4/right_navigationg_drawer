 ...
 * [TrainingCreateGoal.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [TrainingCreateGoal.newInstance] factory method to
 * create an instance of this fragment.
 *
 */
class TrainingCreateGoal : Fragment(), DatePickerDialog.OnDateSetListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view:View = inflater.inflate(R.layout.fragment_training_create_goal, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment TrainingCreateGoal.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                TrainingCreateGoal().apply {
