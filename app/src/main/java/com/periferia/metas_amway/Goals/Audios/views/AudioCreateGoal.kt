 ...
 * [AudioCreateGoal.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [AudioCreateGoal.newInstance] factory method to
 * create an instance of this fragment.
 *
 */
class AudioCreateGoal : Fragment(), DatePickerDialog.OnDateSetListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view: View = inflater.inflate(R.layout.fragment_audio_create_goal, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment AudioCreateGoal.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                AudioCreateGoal().apply {
